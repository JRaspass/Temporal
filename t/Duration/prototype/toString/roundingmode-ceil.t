use Test2::V0 -target => 'Temporal::Duration';

my $duration = Temporal::Duration->new(1, 2, 3, 4, 5, 6, 7, 123, 987, 500);

my $result1 = $duration->toString({ smallestUnit => "microsecond", roundingMode => "ceil" });
is($result1, "P1Y2M3W4DT5H6M7.123988S",
